...
Il bug problema\cite{dotty-bug} è stato segnalato nelle issue del repository GitHub del compilatore Dotty
ed è stato recentemente risolto.

\lstinputlisting[label={lst:builder-syntax-bug},
    caption=Sintassi effettiva del Builder, si notino le annotazioni di tipo superflue ma necessarie per la compilazione del codice.]
