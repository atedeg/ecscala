...
(\eg \texttt{Some(???)} \texttt{\&:} \texttt{None} \texttt{\&:} \texttt{CNil}) avrebbe comportato una
...
\texttt{T1} \texttt{\&:} \texttt{...} \texttt{\&:} \texttt{TN} \texttt{\&:} \texttt{CNil} non è altro
...
stato cancellato (\eg \texttt{C1} \texttt{\&:} \texttt{Deleted} \texttt{\&:} \texttt{CNil} indica che il secondo componente deve essere eliminato
