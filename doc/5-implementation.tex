...
una volta trovata, si iterano tutte le entità contenute al suo interno e per ognuna si controlla che si presente in tutte
le altre mappe.
In caso lo sia, si procede all'estrazione di tutti i suoi componenti richiesti.
