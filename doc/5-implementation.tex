...
Come indicato nella Sezione~\ref{TODO}, l’idea alla base di questa soluzione è stata ispirata dalla libreria
Shapeless; tuttavia, non si è potuto utilizzarla perché era fondamentale avere un vincolo aggiuntivo sul tipo degli
elementi della lista. Infatti, tutti gli elementi di una \texttt{CList} devono essere sottotipi di \texttt{Component}.
