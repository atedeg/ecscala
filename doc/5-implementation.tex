...
$10'000$ entità un sistema impiega mediamente cinque millisecondi ad effettuarne l'aggiornamento, quindi il requisito~\ref{itm:nf1}
...
la \View contenente tutte le entità, i componenti dell'entità che sta venendo modificata, eccetera); tuttavia, l'implementazione del metodo \texttt{update} può necessitare di solo alcuni dei parametri elencati.
