...
\subsection{Tecnologie utilizzate}\label{sec:demo-tecnologie-utilizzate}
...
Inoltre, lo \texttt{SpacePartitionContainer} dispone di un metodo per ottenere tutte le entità facenti parte di una regione
