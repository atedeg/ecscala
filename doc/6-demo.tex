...
\begin{enumerate}[label=\textbf{\ref{subsec:demo-funzionali}.\arabic*}]
    \item \label{itm:df1} Gestire le collisioni tra palle e contro i bordi dell'interfaccia grafica
    ...
    \item \label{itm:df6} Gestire il drag and drop e la selezione
\end{enumerate}
