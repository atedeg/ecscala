...
\section{Tecnologie utilizzate}\label{sec:tecnologie-utilizzate-demo}
Anche per l'implementazione la demo ci sono stati problemi di incompatibilità con Scala 3:
in particolare è stata usata la libreria Mockito invece di ScalaMock e non abbiamo potuto utilizzare ScalaFXML\@.
Per la realizzazione dell'interfaccia grafica è stata utilizzata la libreria ScalaFX\@.
...
\texttt{AnimationTimer}]{code/game-loop.scala}
