...
limitazione degli FPS\@; nel caso in cui si verifichi overrun (situazione dove la computazione impiega più tempo di
quesllo disponibile per il frame corrente), sarà compito della classe regolare di conseguenza gli FPS\@.
