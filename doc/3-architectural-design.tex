...
Una volta aggiunti i \texttt{System} al~\textit{World}, mediante la chiamata al metodo \texttt{update}, è possibile
eseguire i sistemi modificando i componenti su cui essi devono operare.
...
L'esecuzione del sistema consiste nell'eseguire il metodo~\texttt{update}, il quale ritornerà una versione aggiornata
dei componenti.
...
%TODO: descrivere diagramma di sequenza
