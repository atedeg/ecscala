...
class RegionAssignmentSystemTest extends AnyWordSpec with Matchers {
  ...
  "The RegionAssignmentSystem" should {
    "assign a region to each entity" in new RegionAssignmentFixture {
      world.update(0)
      spacePartition get (0, 0) map (_._1) should contain theSameElementsAs List(entity1, entity2)
      spacePartition get (1, 1) map (_._1) should contain theSameElementsAs List(entity3)
