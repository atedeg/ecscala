import sbtghactions.GenerativePlugin.autoImport.{WorkflowStep, githubWorkflowPublishPreamble}

val scala3Version = "3.0.1"

inThisBuild(
  List(
    organization := "it.unibo.ecscala",
...
ThisProject / jacocoReportSettings := JacocoReportSettings().withFormats(JacocoReportFormats.XML)
